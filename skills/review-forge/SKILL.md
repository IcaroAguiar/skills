...
4. Generate the deterministic packet from the exact identity when available:
   `node ~/.agents/skills/review-forge/scripts/collect-review-context.mjs --candidate-mode <mode> --base <sha> [--head <sha>] --candidate-fingerprint <sha256>`.
...
9. Report `REVIEW FORGE COVERAGE`, `CHECKS GREEN`, `FORMAL REVIEW`, and
...
1. `node skills/review-forge/scripts/validate-skill-package.mjs skills/review-forge`
2. `node skills/review-forge/scripts/test-engine-selection.mjs && node skills/review-forge/scripts/test-harness-adapters.mjs`
3. `node skills/review-forge/scripts/test-review-state-fingerprint.mjs`
4. `node skills/review-forge/scripts/test-real-diff-corpus.mjs`
5. `node skills/review-forge/scripts/test-quality-gate-ratchet.mjs`
6. `node skills/review-forge/scripts/test-smoke-cleanup.mjs`
7. `node skills/review-forge/scripts/validate-real-diff-corpus.mjs skills/review-forge/templates/real-diff-corpus.example.json`
