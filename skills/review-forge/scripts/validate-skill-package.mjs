...
const EXPECTED_TEMPLATES = [
  ...
  "review-forge.example.json",
  "review-forge.schema.json",
];
...
expectIncludes("SKILL.md", skillText, "name: review-forge");
...
for (const requiredPath of [
  ...
  "templates/review-forge.schema.json",
  "templates/review-forge.example.json",
  "agents/openai.yaml",
]) {
...
expectIncludes("agents/openai.yaml", openaiText, "display_name: \"Review Forge\"");
expectIncludes("agents/openai.yaml", openaiText, "$review-forge");
...
const configSchema = parseJson("templates/review-forge.schema.json");
if (configSchema.title !== "Review Forge Config") fail("review-forge.schema.json title is stale");
const configExample = parseJson("templates/review-forge.example.json");
if (configExample.$schema !== "./review-forge.schema.json") fail("review-forge.example.json must use the local schema");
