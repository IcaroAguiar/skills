  ...
  const tools = [
      ...
      candidates: [
        {
          ...
          env: {
            ...
            GRYPE_DB_CACHE_DIR: "/tmp/review-loop-grype-db",
          },
          downloads: false,
        },
      ],
      ...
      candidates: [
        {
          ...
          env: {
            XDG_CACHE_HOME: "/tmp/review-loop-cache",
          },
          downloads: false,
        },
        {
      ...
      candidates: [
        {
          ...
          args: ["./..."],
          env: {
            GOCACHE: "/tmp/review-loop-go-cache",
            GOMODCACHE: "/tmp/review-loop-go-mod-cache",
          },
          downloads: false,
        },
      ],
    ...
    },
    {
      ...
      candidates: [
        {
          command: "trivy",
          args: ["config", "--quiet", "--skip-check-update", "--cache-dir", "/tmp/review-loop-trivy-cache", repo.root],
          downloads: false,
        },
      ],
      ...
      candidates: [
        {
          ...
          args: bundleStatsPath ? [bundleStatsPath, "--mode", "static", "--no-open", "--report", "/tmp/review-loop-bundle-report.html"] : ["--version"],
          downloads: false,
        },
        {
          command: "npx",
          args: bundleStatsPath ? ["--yes", "webpack-bundle-analyzer", bundleStatsPath, "--mode", "static", "--no-open", "--report", "/tmp/review-loop-bundle-report.html"] : ["--yes", "webpack-bundle-analyzer", "--version"],
          downloads: true,
        },
      ],
      ...
      candidates: [
        {
          ...
          args: ["-t", dastTarget, "-r", "/tmp/review-loop-zap-report.html"],
          downloads: false,
        },
      ],
