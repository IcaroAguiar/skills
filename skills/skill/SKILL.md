...
Meta-skill for managing local agent skills via CLI-like commands.
...
After scanning, offer these options using `request_user_input` when available. If structured user input is unavailable, ask one concise plain-text question:
