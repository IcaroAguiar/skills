...
description: Gating testability for material code, bugfix, UI/browser, auth/permission, API/contract/data/config, shared-library, CI, PR, release, and review-forge workflows that need reliable evidence.
---
...
This complements `review-forge`: review finds implementation and maintainability risk; this gate decides whether the changed behavior was proven.
...
- `references/review-forge-integration.md`: closeout and review-approval integration.
