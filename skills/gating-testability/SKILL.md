...
description: Gating testability for material code, bugfix, UI/browser, auth/permission, API/contract/data/config, shared-library, CI, PR, release, and code-review workflows that need reliable evidence.
---
...
This complements `code-review`: review finds implementation and maintainability risk; this gate decides whether the changed behavior was proven.
...
- `references/code-review-integration.md`: closeout and review-approval integration.
