...
Read [`references/review-standards.md`](references/review-standards.md). Its five
gates and test-evidence rule apply to every review. Repository rules override
heuristic smells, but do not remove a gate.
